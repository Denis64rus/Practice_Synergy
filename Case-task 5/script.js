...
const clearBtn = document.querySelector('.header_clear-btn');
const sortBtn = document.querySelector('.header_sort-btn');
const starImportantBtn = document.querySelectorAll('.star-important');
const drawerItems = document.querySelectorAll('.todo_drawer-item');

const createTaskInput = document.querySelector('.create-task-input');

const taskList = document.querySelector('.task-list');
const resolvedTasksList = document.querySelector('.resolved_tasks-list');
...
function renderTaskList() {
    ...
    doneTasks.forEach(element => {
        const taskComponent = /*html*/ `
            <div class="main_list-item" data-id="${element.id}">
                <p>${element.text}</p>
                <div class="important">
                    <svg
                        class="cross-err-btn"
...
function renderSimpleTask(position, element) {
    const taskComponent = /*html*/ `
    <div class="main_list-item main_list-sort" data-id="${element.id}">
...
function deleteTask(target, typeTasks) {
    const taskToDelete = target.closest('.main_list-item');
    taskToDelete.remove();
...
function makeImportantTask(target) {
    const task = target.closest('.main_list-item');
...
function doneTask(target) {
    ...
    const taskComponent = /*html*/ `
    <div class="main_list-item" data-id="${doneTask.id}">
        <p>${doneTask.text}</p>
        <div class="important">
            <svg
                class="cross-err-btn"
...
sortBtn.addEventListener('click', () => {
    const allTasks = document.querySelectorAll('.main_list-sort');
    allTasks.forEach(element => {
        element.remove();
    });
